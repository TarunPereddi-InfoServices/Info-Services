...
export default function Component() {
  return (
    <div className="w-full max-w-full min-h-[100vh] flex flex-col items-center justify-center mx-auto p-10 rounded-t-3xl bg-gradient-to-r from-[#684FB2] via-[#9023AE] to-[#405F9E] text-white">
