...
const DarkLight = () => {
  ...
  return (
    ...
    <div className="mode-container">
      <span className={`mode ${isDarkModeActive ? 'mode-active':''}`} onClick={toggleModeHandler}>Dark</span>
      <span className={`mode ${!isDarkModeActive ? 'mode-active':''}`} onClick={toggleModeHandler}>Light</span>
    </div>
    </div>
  );
};
